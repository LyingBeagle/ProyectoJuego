...
public class PantallaJuego implements Screen {
    ...
    public PantallaJuego(PuertaMagica game, int ronda, int vidasJugador, int vidasEnemigo, int score,  
        ...
        nave = new Jugador(Gdx.graphics.getWidth()/2-50, 30, new Texture(Gdx.files.internal("MainShip3.png")),
                        Gdx.audio.newSound(Gdx.files.internal("hurt.ogg")), 
                        new Texture(Gdx.files.internal("Rocket2.png")), 
                        Gdx.audio.newSound(Gdx.files.internal("pop-sound.mp3"))); 
        nave.setVidas(vidasJugador);
    ...
    public void render(float delta) {
        ...
        batch.end();
        // Nivel completado
        //System.out.println("DEBUG: Estado del enemigo Vidas: " + enemigo.getVidas() + "- Destruida: " + enemigo.estaDestruido());
    ...
    private void avanzarARondaSiguiente(){
        Screen ss = new PantallaJuego(game, ronda + 1, nave.getVidas(), 3, score, 
