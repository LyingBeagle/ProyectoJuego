...
public abstract class Projectile {
    ...
    public Projectile(int x, int y, int size, int xSpeed, int ySpeed, Texture tx, EstrategiaMovimiento estrategia) {
        spr = new Sprite(tx);
        this.x = x; 
    ...
    public void checkCollisionBall(Projectile b2) {
    ...
    public boolean checkCollision(Projectile o) {
        return true;
    }
